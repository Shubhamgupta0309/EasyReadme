...
class ApiService {
    ...
    async generateReadme(repositoryData: any, options: any = {}): Promise<ApiResponse> {
        return this.request('/api/ai/generate-readme', {
            method: 'POST',
            body: JSON.stringify({ repositoryData, options }),
        });
    }
    ...
    // Preview README with options
    async previewReadme(repositoryData: any, options: any = {}): Promise<ApiResponse> {
